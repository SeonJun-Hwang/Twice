...
public class BookListAdapter extends BaseAdapter {
    private ArrayList<BookPostVO> listViewItemList = new ArrayList<BookPostVO>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BookPostVO listViewItem = listViewItemList.get(position);
    ...
    public void addItem(String date, String post) {
        BookPostVO item = new BookPostVO();

        item.setDate(date);
        item.setMessage(post);
